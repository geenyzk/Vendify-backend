...
return new class extends Migration
{
    ...
    {
        // MySQL limits identifiers to 64 characters. Explicit short index names
        // also let this migration resume after an earlier deployment created
        // the agents table but failed while adding its generated long index.
        ...
        } elseif (! Schema::hasIndex('whatsapp_support_agents', 'wa_agents_routing_idx')) {
            Schema::table('whatsapp_support_agents', function (Blueprint $table) {
                $table->index(['enabled', 'availability', 'last_assigned_at'], 'wa_agents_routing_idx');
            });
        }
