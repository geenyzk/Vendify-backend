...
{
    //
    protected $fillable = ["id", "name", "code", "base_url", "username", "password", "identifier", "sub_category", "category", "api_key", "secret_key", "webhook_access", "charge_fee", "charge_type", "active",
